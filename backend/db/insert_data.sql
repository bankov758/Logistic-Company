...
INSERT INTO `company` VALUES (1,'DHL');
...
INSERT INTO `office` VALUES (1,'lovech',1);
...
INSERT INTO `office_employee` VALUES (1,1);
...
INSERT INTO `shipment` VALUES (1,'lovech','varna',0,1,2,0,0,1,150,'2024-02-11 17:12:38','2024-02-11 17:12:38',2),(3,'lovech','varna',0,1,2,0,0,1,100,'2024-02-11 17:12:38',NULL,2);
...
CREATE TABLE `tariff` (
  ...
  KEY `fk_tarriffs_company1_idx` (`company_id`),
...
INSERT INTO `user` VALUES (1,'alex','123456789','alex','alexov'),(2,'ivo','123456789','ivo','ivov'),(4,'pesho','1234567689','pesho','peshov');
...
CREATE TABLE `user_roles` (
  ...
  UNIQUE KEY `unique_role` (`user_id`,`roles`),
...
-- Dump completed on 2024-02-18 15:41:17
