...
CREATE TABLE IF NOT EXISTS `logistic_company`.`shipment` (
                                                             ...
                                                             `is_sent_from_office` BINARY NOT NULL,
                                                             `is_recieved_in_office` BINARY NOT NULL,
...
CREATE TABLE IF NOT EXISTS `logistic_company`.`tarriffs` (
                                                             `id` INT NOT NULL AUTO_INCREMENT,
                                                             `price_per_kg` FLOAT NULL DEFAULT NULL,
                                                             `office_discount` FLOAT NULL DEFAULT NULL,
                                                             `company_id` INT NOT NULL,
                                                             PRIMARY KEY (`id`),
