...
export const getCompanies = async (session: { username: string; } | null): Promise<selectorItem[] | null> =>{
	try {
...
export const getCouriers = async (session: { username: string; } | null): Promise<selectorItem[] | null> =>{
	try {
...
export const getUsers = async (session: { username: string; } | null): Promise<selectorItem[] | null> => {
	try {
